/**
 * Based on Gist: https://gist.github.com/clauswitt/1604972/
 * Modified to use Miles vs KM
 */
 

//Use 70 as filter distance.  Slightly greater than the widest point between lat and long
...
//return is distance in miles. 
exports.getDistance = function(start, end, decimals) {
    decimals = decimals || 2;
    var earthRadius = 3961; // Mi
